...
namespace eduTask
{
    ...
    public partial class consultarMatematica : Form
    {
        DAO consul;
        ...
        public void adicionardados()
        {
            ...
            for (int i = 0; i < consul.QuantidadeDeDados(); i++)
            {
                ...
                if (materiaSemAcento == "matematica") // ou se a comparação for com "Matemática"
                {
        ...
        private void consultarMatematica_Load(object sender, EventArgs e)
        {
