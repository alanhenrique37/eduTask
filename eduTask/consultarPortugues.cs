...
namespace eduTask
{
    public partial class consultarPortugues : Form
    {
        DAO consul;
        ...
        public void adicionardados()
        {
            ...
            for (int i = 0; i < consul.QuantidadeDeDados(); i++)
            {
                ...
                if (materiaSemAcento == "portugues") // ou se a comparação for com "Matemática"
                {
        ...
        private void consultarPortugues_Load(object sender, EventArgs e)
        {
