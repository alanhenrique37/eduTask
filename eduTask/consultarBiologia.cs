...
namespace eduTask
{
    public partial class consultarBiologia : Form
    {
        DAO consul;
        ...
        public void adicionardados()
        {
            ...
            for (int i = 0; i < consul.QuantidadeDeDados(); i++)
            {
                ...
                if (materiaSemAcento == "biologia") // ou se a comparação for com "Matemática"
                {
        ...
        private void consultarBiologia_Load(object sender, EventArgs e)
        {
